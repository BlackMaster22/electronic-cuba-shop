...
const SHIPPING_COST = 1500; // Costo fijo de envío en CUP
...
export function CartModal({ isOpen, onClose }: CartModalProps) {
    ...
    const handleCheckout = async () => {
        ...
        const orderData = {
            ...
            requiresShipping,
            shippingCost: requiresShipping ? SHIPPING_COST : 0,
            finalTotal,
        ...
        try {
            ...
            if (response.ok) {
                ...
                onClose();
                // Mostrar éxito
                alert('¡Compra realizada con éxito! Tu pedido está en proceso.');
            } else {
